...
\ihead{Vanilla}
1 tsp vanilla extract
1/2 tsp butter, to finish

\ihead{Cocoa}
remove 1 tsp cornstarch
2 tbsp cocoa powder
1 square chocolate, to finish
\end{ingredients}
\nextcolumn
Serves 2
\begin{steps}
    \item Whisk together dry ingredients
    \item Flavor milk with extracts or steeping
    \item Bring to boil whisking constantly until liquid thickens
    \item Whisk in fat to finish
