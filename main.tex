...
Serves 4
\begin{steps}
\item In a small bowl, combine 2 tbsp ketchup with Worcestershire sauce
\item In a medium bowl, combine turkey, zucchini, dried onion, oats or breadcrumbs, egg, 4 tbsp ketchup, salt, and marjoram
...
Serve as a salad dressing, dipping sauce for artichokes, drizzled over asparagus, or as a sauce for grilled or pan-fried fish or chicken.
\end{denserecipe}
...
\item To cook, add wontons to boiling water, bring back to boil, simmer until they float, continue simmering for 2 minutes
\end{steps}
\end{denserecipe}
...
\item Sprinkle mozzarella and olives over carrots and shallots, then top with seasoned bread crumbs
...
\item Fold meringue into yolk mixture until just combined
\item Preheat non-stick pan on low heat, and grease lightly
\item Pour batter in small mounds, sprinkle water around, cook covered for 4 to 5 minutes, then flip and cook for 4 to 5 minutes more
\end{steps}
\end{denserecipe}
