...
\begin{recipe}{Hollandaise Sauce}{\totaltime{10 min}}
\begin{ingredients}
2 egg yolks
1 tbsp lemon juice
...
\begin{recipe}{Simple Pie Crust}{\totaltime{1 h 15 min}}
\begin{ingredients}
150 g flour
1/4 tsp salt
...
\begin{denserecipe}{Heirloom Tomato Tart}{\preheat{\fahrenheit{375}}\totaltime{1 h 30 min}}
\begin{ingredients}
simple pie crust
...
\begin{recipe}{Miso-Sesame Vinaigrette}{\preheat{\fahrenheit{350}}\totaltime{10 min}}
\begin{ingredients}
2 tbsp sesame seeds
...
\begin{recipe}{Lemony Asparagus Soup}{\totaltime{15 min}}
\begin{ingredients}
...
\begin{recipe}{Peaches in Muscat}{\totaltime{2 h}}
\begin{ingredients}
4 ripe peaches
...
\begin{recipe}{Braised Peppers and Onions}{\totaltime{40 min}}
\begin{ingredients}
2 tbsp oil
