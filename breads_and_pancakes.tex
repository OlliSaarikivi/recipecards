...
\begin{denserecipe}{All-Purpose Enriched Dough}{\vegetarian\totaltime{7 h}}
\begin{ingredients}
250 g whole milk
50 + 500 g flour
...
\begin{recipe}{Banana Almond Pancakes}{\vegetarian\totaltime{20 min}}
\begin{ingredients}
1 banana
2 eggs
1 dl almond flour
...
\begin{recipe}{Cream Biscuits}{\vegetarian\preheat{\celsius{200}}\totaltime{25 min}}
\begin{ingredients}
2 dl flour
2 tsp baking powder
1/2 tsp kosher salt
...
\end{steps}
Serve with \reciperef{Sausage Gravy}.
\end{recipe}

\begin{recipe}{Crepes}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
1 large eggs
5/8 cups whole milk
1/2 cup flour
...
\end{steps}
\ihead{Fillings}\\
Sweet: sugar lemon\ijoin{}juice whipped\ijoin{}cream jam berries nutella \\
Savory: \reciperef{Salmon Pate} mushrooms ham cheese fried\ijoin{}eggs asparagus \reciperef{Hollandaise}
\end{recipe}

\begin{recipe}{Gullichsenin Letut}{\vegetarian\totaltime{1 h 10 min}}
\begin{ingredients}
4 dl flour
1 tsp baking powder
1/2 tsp salt
...
\begin{denserecipe}{Hamburger Buns}{\vegetarian\preheat{\celsius{180}}\totaltime{2 h 30 min}}
\begin{ingredients}
\reciperef{All-Purpose Enriched Dough}
1 egg, beaten
...
\begin{denserecipe}{Low-Knead Bread}{\vegetarian\totaltime{14 h to 3 days}}
\begin{ingredients}
400 g bread flour
...
\end{ingredients}
\nextcolumn
This is a variation on \reciperef{No-Knead Bread} with additional folds and higher hydration.
\begin{steps}
    \item Make the dough as in \reciperefplain{No-Knead Bread}
    ...
    \item Shape, proof and bake as in \reciperefplain{No-Knead Bread}
\end{steps}
\end{denserecipe}

\begin{denserecipe}{No-Knead Bread}{\vegetarian\preheat{\celsius{260}}\totaltime{14 h}}
\begin{ingredients}
400 g bread flour
8 g salt (2 tsp kosher)
2 g instant dry yeast (1/2 tsp) or 2.25 g active dry yeast (heaping 1/2 tsp)
...
\begin{recipe}{Potato Flat Bread}{\vegetarian\preheat{\celsius{260}}\totaltime{30 min}}
\begin{ingredients}
3 dl potato puree
...
\begin{denserecipe}{Oat and Carrot Rolls}{\vegetarian\preheat{\celsius{190}}\totaltime{2 h}}
\begin{ingredients}
35 g + 415 g flour
170 g + 170 g milk
2 dl grated carrot
...
\begin{recipe}{Pain de Mie}{\vegetarian\preheat{\celsius{180}}\totaltime{3h 30 min}}
\begin{ingredients}
\ihead{Tangzhong}
30 g flour
150 ml milk
