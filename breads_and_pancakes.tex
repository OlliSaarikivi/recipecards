...
\begin{ingredients}
1 batch \reciperef{All-Purpose Enriched Dough}, chilled
1 egg, beaten
...
\begin{steps}
    \item Make the dough as in \reciperef{No-Knead Bread}
    ...
    \item Shape, proof and bake as in \reciperef{No-Knead Bread}
\end{steps}
\end{denserecipe}
