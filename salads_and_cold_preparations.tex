...
\begin{denserecipe}{American Chicken Salad}{\totaltime{2 h}}
\begin{ingredients}
...
\end{steps}
Use in sandwiches, \reciperef{Choux Pastry} puffs or \reciperef{Crepes}. 
\end{denserecipe}

\begin{recipe}{Snap Pea and Chicken Salad}{\totaltime{40 min}}
\begin{ingredients}
...
\begin{recipe}{Carrot Salad}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
...
\begin{denserecipe}{Spicy Corn Salad}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
2+1 tbsp olive oil
2 tbsp lime juice
...
\begin{recipe}{Orange and Radish Salad}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
...
\begin{recipe}{Egg Salad for Tea Sandwiches}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
2 hard boiled eggs
1 tbsp mayonnaise
1 tbsp yoghurt
...
\begin{densecard}{Potato Salads}{\vegetarian\totaltime{40 min}}
\begin{densesteps}
...
\begin{recipe}{Summer Corn and Tomato Salad}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
...
\begin{denserecipe}{Orzo, Lentil and Zucchini Salad}{\vegetarian\totaltime{40 min}}
\begin{ingredients}
1 cup lentils
1 cup orzo
1/2 cup olive oil
...
\begin{denserecipe}{Brussels Sprouts Caesar Salad}{\vegetarian\preheat{\celsius{220}}\totaltime{35 min}}
\begin{ingredients}
...
\begin{denserecipe}{Cucumber and Avocado Salad}{\vegetarian\totaltime{10 min}}
\begin{ingredients}
...
\begin{denserecipe}{Esquites Salad}{\vegetarian\totaltime{20 min}}
\begin{ingredients}
2 tbsp oil
...
\begin{recipe}{Beet and Goat Cheese Salad}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
\reciperef{Balsamic Beets}
4 pucks \reciperef{Crispy Goat Cheese}
1/4 cup \reciperef{Blonde Vinaigrette}
...
\begin{recipe}{Gazpacho Pasta Salad}{\vegetarian\totaltime{1 day}}
\begin{ingredients}
...
\begin{recipe}{Tzatziki Chickpea Salad}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
1 cup greek yogurt
...
Serves 4
\begin{steps}
    \item Whisk together yogurt, garlic, olive oil, honey and lemon juice
    \item Season well with salt and pepper
    \item Cut cucumbers into half moons, drain chickpeas, chop herbs and slice scallions
    \item Add dressing and toss to combine
    \item Check for seasoning
    \item Drizzle with more olive oil
\end{steps}
\end{recipe}
