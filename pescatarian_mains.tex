...
\end{steps}
Serve with \reciperef{Soy Reduction} over rice.
\end{recipe}

\begin{denserecipe}{Egg and Tomato}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
4 eggs
1/2 tsp kosher salt
...
\begin{denserecipe}{Mushroom Strogaonoff}{\vegetarian\totaltime{30 min}}
\begin{ingredients}
...
\end{ingredients}
\nextcolumn
\lihead{Florentine}\hfill \raisebox{-0.3em}{\recipesecref{Creamed Spinach}}

\begin{ingredients}
2 tbsp \reciperefplain{Creamed Spinach}
nutmeg, for garnish
\end{ingredients}
...
\begin{recipe}{Scallops with Preserved Lemon}{\totaltime{20 min}}
\begin{ingredients}
2 tbsp butter
2 sprigs rosemary
2 cloves garlic, minced
...
\begin{denserecipe}{Fish in Salty Tomato Sauce}{\totaltime{25 min}}
\begin{ingredients}
...
\begin{denserecipe}{Roasted Vegetables and Mozzarella}{\vegetarian\preheat{\celsius{220}}\totaltime{1 h}}
\begin{ingredients}
...
\begin{denserecipe}{Tomato Egg Drop}{\vegetarian\totaltime{30 min}}
\begin{ingredients}
3 large eggs, beaten
neutral oil
...
\begin{recipe}{Crispy Goat Cheese}{\preheat{\celsius{250}}\totaltime{1 h 20 min}}
\begin{ingredients}
...
\begin{recipe}{Crispy Halloumi and Beans}{\vegetarian\totaltime{30 min}}
\begin{ingredients}
olive oil
