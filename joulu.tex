...
\begin{recipe}{Extra-Light and Foamy Eggnog}{\vegetarian\totaltime{15 min}}
\begin{ingredients}
4 eggs, separated
70 g sugar
350 ml whole milk
...
\begin{recipe}{Figgy Christmas Star Filling}{\vegetarian\totaltime{30 min}}
\begin{ingredients}
...
\begin{recipe}{Rice Porridge}{\vegetarian\totaltime{45 min}}
\begin{ingredients}
...
\begin{recipe}{Dried Fruit Soup}{\vegetarian\totaltime{20 min}}
\begin{ingredients}
...
\begin{denserecipe}{Rutabaga Casserole}{\vegetarian\preheat{\celsius{180}}\totaltime{2 h 40 min}}
\begin{ingredients}
...
\begin{recipe}{Creamy Mushroom Salad}{\vegetarian\totaltime{1 h}} % joulu
\begin{ingredients}
...
\begin{denserecipe}{Coastal Bread}{\vegetarian\preheat{\celsius{180}}\totaltime{4 h}}
\begin{ingredients}
...
\begin{recipe}{Glögi Syrup}{\vegetarian\totaltime{40 min}}
\begin{ingredients}
1 cup water
2 cups sugar
...
\begin{recipe}{Piimäjuusto}{\vegetarian\totaltime{7 hours}}
\begin{ingredients}
1 1/2 l whole milk
...
\begin{recipe}{Mustard}{\vegetarian\totaltime{20 min}}
\begin{ingredients}
...
1 tbsp oil
1 egg
1 tbsp white wine \ibreak vinegar
\end{ingredients}
\nextcolumn
Makes 3 dl
\begin{steps}
    \item Whisk together mustard powder, sugar and salt
    \item Whisk in cream, oil and egg
    \item Bring to boil, scraping bottom to prevent burning
    \item Let boil for a moment until mixture thickens
    \item Add vinegar
\end{steps}
\end{recipe}